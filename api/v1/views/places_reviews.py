#!/usr/bin/python3
'''Contains API places_reviews view.'''
...
def handle_reviews(place_id=None, review_id=None):
    '''Method handler dictionary for reviews endpoint.
    '''
    handlers = {
        'GET': get_reviews,
...
def get_reviews(place_id=None, review_id=None):
    '''
    Gets review object with given id or all
    reviews in the place with given id.
    '''
    if place_id:
...
def remove_review(place_id=None, review_id=None):
    '''Removes review object with given id.
    '''
    review = storage.get(Review, review_id)
    if review:
...
def update_review(place_id=None, review_id=None):
    '''Updates review object with given id.
    '''
